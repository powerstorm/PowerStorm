...
namespace PowerStormReadingGatherer
{
	public static class Constants
	{
        ...
        public const int ENVISION_DATABASE_INDEX = 0;
        public const int ENVISION_DATABASE_TIMEOFSAMPLE = 1;
        public const int ENVISION_DATABASE_SEQUENCE = 2;
        public const int ENVISION_DATABASE_VALUETYPE = 3;
        public const int ENVISION_DATABASE_SAMPLEVALUE = 4;
